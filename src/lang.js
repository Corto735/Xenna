...
export const STATIC_DICT = {
  ...
  'SALAIRE BRUT (USD)':     ['GROSS SALARY (USD)', 'BRUTTOGEHALT (USD)', 'BRUTOLOON (USD)', 'RETRIBUZIONE LORDA (USD)', 'SALARIO BRUTO (USD)'],
  'BRUT (USD)':             ['GROSS (USD)', 'BRUTTO (USD)', 'BRUTO (USD)', 'LORDO (USD)', 'BRUTO (USD)'],
  ...
  // Absence maladie / IJSS (subrogation + garantie du net)
  ...
  'Diviseur mensuel':         ['Monthly divisor', 'Monatsdivisor', 'Maanddeler', 'Divisore mensile', 'Divisor mensual'],
  'Retenue absence':          ['Absence deduction', 'Abwesenheitsabzug', 'Inhouding afwezigheid', 'Trattenuta assenza', 'Retención por ausencia'],
  'Maintien de salaire':      ['Salary maintenance', 'Lohnfortzahlung', 'Loondoorbetaling', 'Mantenimento salariale', 'Mantenimiento salarial'],
  'IJSS brutes':              ['Gross IJSS benefits', 'IJSS-Tagegelder brutto', 'Bruto IJSS-uitkeringen', 'IJSS lorde', 'IJSS brutas'],
  'IJSS brutes reversées':    ['Gross IJSS passed on', 'Weitergeleitete IJSS brutto', 'Doorgestorte bruto IJSS', 'IJSS lorde riversate', 'IJSS brutas transferidas'],
  'SJB (× 3 ÷ 91,25)':        ['Daily base wage (× 3 ÷ 91.25)', 'Tagesgrundlohn (× 3 ÷ 91,25)', 'Dagloon (× 3 ÷ 91,25)', 'Salario giornaliero base (× 3 ÷ 91,25)', 'Salario diario base (× 3 ÷ 91,25)'],
  'IJ journalière (50 %)':    ['Daily benefit (50 %)', 'Tagegeld (50 %)', 'Daguitkering (50 %)', 'Indennità giornaliera (50 %)', 'Prestación diaria (50 %)'],
  'Assiette de référence (salaire − retenue + maintien)': ['Reference base (salary − deduction + maintenance)', 'Referenzgrundlage (Gehalt − Abzug + Fortzahlung)', 'Referentiegrondslag (loon − inhouding + doorbetaling)', 'Base di riferimento (salario − trattenuta + mantenimento)', 'Base de referencia (salario − retención + mantenimiento)'],
  'Net de référence = net(assiette de référence)': ['Reference net = net(reference base)', 'Referenznetto = Netto(Referenzgrundlage)', 'Referentienetto = netto(referentiegrondslag)', 'Netto di riferimento = netto(base di riferimento)', 'Neto de referencia = neto(base de referencia)'],
  'Cible hors IJSS (net de référence − IJSS)': ['Target excluding IJSS (reference net − IJSS)', 'Ziel ohne IJSS (Referenznetto − IJSS)', 'Doel zonder IJSS (referentienetto − IJSS)', 'Obiettivo senza IJSS (netto di riferimento − IJSS)', 'Objetivo sin IJSS (neto de referencia − IJSS)'],
  'Assiette résolue par dichotomie': ['Base solved by bisection', 'Durch Bisektion gelöste Grundlage', 'Grondslag opgelost via bisectie', 'Base risolta per dicotomia', 'Base resuelta por dicotomía'],
  'Ajustement (réf. − IJSS − assiette)': ['Adjustment (ref. − IJSS − base)', 'Ausgleich (Ref. − IJSS − Grundlage)', 'Aanpassing (ref. − IJSS − grondslag)', 'Aggiustamento (rif. − IJSS − base)', 'Ajuste (ref. − IJSS − base)'],
  'Net après cotisations (assiette − cotisations salariales)': ['Net after contributions (base − employee contributions)', 'Netto nach Beiträgen (Grundlage − Arbeitnehmerbeiträge)', 'Netto na bijdragen (grondslag − werknemersbijdragen)', 'Netto dopo i contributi (base − contributi dipendente)', 'Neto tras cotizaciones (base − cotizaciones del trabajador)'],
...
export const CAT_DICT = {
  ...
  'Impôt fédéral':           ['Federal tax', 'Bundessteuer', 'Federale belasting', 'Imposta federale', 'Impuesto federal'],
  "Impôt d'État":            ['State tax', 'Bundesstaatssteuer', 'Deelstaatbelasting', 'Imposta statale', 'Impuesto estatal'],
...
export const COUNTRY_DICT = {
  ...
  'États-Unis': ['United States', 'Vereinigte Staaten', 'Verenigde Staten', 'Stati Uniti', 'Estados Unidos'],
  'Mexique': ['Mexico', 'Mexiko', 'Mexico', 'Messico', 'México'],
  'Brésil': ['Brazil', 'Brasilien', 'Brazilië', 'Brasile', 'Brasil'],
  'Émirats arabes unis': ['United Arab Emirates', 'Vereinigte Arabische Emirate', 'Verenigde Arabische Emiraten', 'Emirati Arabi Uniti', 'Emiratos Árabes Unidos'],
  'Inde': ['India', 'Indien', 'India', 'India', 'India'],
