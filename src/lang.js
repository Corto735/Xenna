...
export const STATIC_DICT = {
  ...
  de: {
    ...
    // App meta
    'simulateur pédagogique · bulletin de paye français · v0.1.5':
      'pädagogischer Simulator · Französische Gehaltsabrechnung · v0.1.5',
  ...
  nl: {
    ...
    // App meta
    'simulateur pédagogique · bulletin de paye français · v0.1.5':
      'educatieve simulator · Franse loonbrief · v0.1.5',
